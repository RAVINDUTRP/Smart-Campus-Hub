...
|---|---|---|---|---|---|---|
| WS1 | A | /api/v1/resources | POST | Create resource | CataloguePage resource form | Planned |
| WS1 | A | /api/v1/resources | GET | List resources with filters | CataloguePage resource table | Planned |
| WS1 | A | /api/v1/resources/{id} | PUT | Update resource | CataloguePage edit modal | Planned |
| WS1 | A | /api/v1/resources/{id} | DELETE | Delete resource | CataloguePage delete action | Planned |
